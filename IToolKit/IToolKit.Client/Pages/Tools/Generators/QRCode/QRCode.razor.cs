using IToolKit.Client.API.Enums.Tools.Generators;
using IToolKit.Client.API.Tools.Generators;
using MudBlazor.Utilities;
using static IToolKit.Client.API.Tools.Generators.QRCodeTools;
